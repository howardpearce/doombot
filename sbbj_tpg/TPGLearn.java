...
public class TPGLearn
{
	...
	public TPGLearn( Map<String, String> arguments ) throws IOException
	{
		//open file to output info
		output = new File("TPGOUTPUT" + System.currentTimeMillis() + ".csv");

		output.createNewFile();

		outputResults = new FileWriter(output);

		outputResults.append("Generation,Root Teams,Teams,Learners,Average Score, Highest Score,\r\n");
	...
	public void printStats( int teamCount ) throws IOException
	{
		...
		outputResults.append(epochs + "," + rootTeams.size() + "," + teams.size() + "," + learners.size() + ",");
		...
		for( int i=0; i < teamCount; i++ ) {
			...
			avg += outcomeMap.get(rootCopy.get(i)).get(0);
		}

		System.out.println("Average score: " + avg/teamCount);
		outputResults.append(avg/teamCount +",\n");
